...
import SellersControlScreen from './components/SellersControlScreen';
    ...
    <GestureHandlerRootView style={styles.container}>
      <NavigationContainer>
        <Stack.Navigator initialRouteName="Splash" screenOptions={{ headerShown: false }}>
          ...
          <Stack.Screen 
            name="SellersControl" 
            component={SellersControlScreen} 
            options={{ title: 'التحكم في البائعين' }} 
          />
          <Stack.Screen 
            name="ChangeProfileScreen" 
            component={ChangeProfileScreen} 
            options={{ title: 'تغيير الملف الشخصي' }} 
          />
